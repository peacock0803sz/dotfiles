...
let
  sources = {
    ...
    "@google/gemini-cli-core-0.24.5" = {
      name = "_at_google_slash_gemini-cli-core";
      packageName = "@google/gemini-cli-core";
      version = "0.24.5";
      src = fetchurl {
        url = "https://registry.npmjs.org/@google/gemini-cli-core/-/gemini-cli-core-0.24.5.tgz";
        sha512 = "qr0HPGZJWsXfPCqLyrSaIrq2LNj5snbnFONRG4ne9Nq0d7oI6QDPWf2MBIs3QAn9n+wAWImxrPTcuUJ+OK6W/w==";
      };
    };
    "@google/genai-1.30.0" = {
    ...
    "conf-15.0.2" = {
      ...
      src = fetchurl {
        ...
        sha512 = "JBSrutapCafTrddF9dH3lc7+T2tBycGF4uPkI4Js+g4vLLEhG6RZcFi3aJd5zntdf5tQxAejJt8dihkoQ/eSJw==";
      };
    };
    "config-chain-1.1.13" = {
      name = "config-chain";
    ...
    "tree-sitter-bash-0.25.1" = {
      ...
      src = fetchurl {
        ...
        sha512 = "7hMytuYIMoXOq24yRulgIxthE9YmggZIOHCyPTTuJcu6EU54tYD+4G39cUb28kxC6jMf/AbPfWGLQtgPTdh3xw==";
      };
    };
    "type-fest-2.19.0" = {
      name = "type-fest";
    ...
    "type-fest-5.4.1" = {
      ...
      src = fetchurl {
        ...
        sha512 = "xygQcmneDyzsEuKZrFbRMne5HDqMs++aFzefrJTgEIKjQ3rekM+RPfFCVq2Gp1VIDqddoYeppCj4Pcb+RZW0GQ==";
      };
    };
    "type-is-2.0.1" = {
      name = "type-is";
...
in
{
  ...
  gemistat = nodeEnv.buildNodePackage {
    name = "gemistat";
    packageName = "gemistat";
    version = "0.1.1";
    src = fetchurl {
      url = "https://registry.npmjs.org/gemistat/-/gemistat-0.1.1.tgz";
      sha512 = "bbAPluw/BtFzYuM5qSXDQqCBoERi0s/Ch1Lf1teUcHh3uzbs01WEZxGKXOjXaP4ufp3jN4UAGhroxEpmbMaFLA==";
    };
    buildInputs = globalBuildInputs;
    meta = {
  ...
  "@github/copilot-language-server" = nodeEnv.buildNodePackage {
    ...
    version = "1.411.0";
    src = fetchurl {
      url = "https://registry.npmjs.org/@github/copilot-language-server/-/copilot-language-server-1.411.0.tgz";
      sha512 = "KxuvWq3DT4qTujxtgDQTHmynWawDiwqsRC9BmuBVi5PyzdyejJEj6rgcuwH7WcOMgNQJlHVQmSxN6uYurqp26w==";
    };
    dependencies = [
  ...
  "@google/gemini-cli" = nodeEnv.buildNodePackage {
    ...
    src = fetchurl {
      ...
      sha512 = "vK+fqFYD5RtV4vZrciwMIzkX7uqiIXxiYoDbb6+mic1bcslEqSTt+GYBwATDjmZlorlzAGUYePn68y4Hu5o11g==";
    };
    dependencies = [
      ...
      (sources."@google/gemini-cli-core-0.24.5" // {
        dependencies = [
          (sources."gaxios-6.7.1" // {
            dependencies = [
              sources."uuid-9.0.1"
  ...
  "@typescript/native-preview" = nodeEnv.buildNodePackage {
    ...
    src = fetchurl {
      ...
      sha512 = "nnEf37C9ue7OBRnF2zmV/OCBmV5Y7T/K4mCHa+nxgiXcF/1w8sA0cgdFl+gHQ0mysqUJ+Bu5btAMeWgpLyjrgg==";
    };
    buildInputs = globalBuildInputs;
    meta = {
