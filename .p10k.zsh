# Generated by Powerlevel10k configuration wizard on 2020-11-17 at 11:21 JST.
# Based on romkatv/powerlevel10k/config/p10k-lean.zsh, checksum 47471.
# Wizard options: ascii, lean, 24h time, 2 lines, disconnected, sparse, concise,
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    example                 # show python version if exist ./venv
